        ...
        {activeTab === 'dashboard' && (
          <div className="space-y-6">
            ...
            <Card className="border-purple-200 bg-gradient-to-r from-purple-50 to-white">
              <CardContent className="p-6">
                <h2 className="text-lg font-semibold text-purple-800 mb-2">Staff Portal</h2>
                <p className="text-purple-700">
                  As a staff member, you can report lost items and track their status. 
                  You also have access to departmental lost and found updates.
                </p>
              </CardContent>
            </Card>
